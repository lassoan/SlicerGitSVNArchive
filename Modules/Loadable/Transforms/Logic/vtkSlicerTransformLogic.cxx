  ...
  vtkMRMLMarkupsFiducialNode* markupsNode /*=NULL*/)
{
  ...
  if (markupsNode != NULL)
  {
    ...
    vtkSlicerTransformLogic::GetMarkupsAsPoints(markupsNode, samplePoints_RAS);
  }
...
bool vtkSlicerTransformLogic::GetVisualization3d(vtkPolyData* output, vtkMRMLTransformDisplayNode* displayNode, vtkMRMLNode* regionNode)
{
  ...
  vtkSmartPointer<vtkPoints> samplePoints_RAS;
  vtkMRMLMarkupsFiducialNode* markupsNode = vtkMRMLMarkupsFiducialNode::SafeDownCast(regionNode);
  if (markupsNode != NULL)
    {
    samplePoints_RAS = vtkSmartPointer<vtkPoints>::New();
    vtkSlicerTransformLogic::GetMarkupsAsPoints(markupsNode, samplePoints_RAS);
