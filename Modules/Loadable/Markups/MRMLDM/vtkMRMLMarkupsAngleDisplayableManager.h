...
protected:
  ...
  vtkMRMLMarkupsAngleDisplayableManager3D(){this->Focus="vtkMRMLMarkupsFiducialNode";}
  ...
  void SetNthSeed(int n, vtkMRMLMarkupsFiducialNode* fiducialNode, vtkAngleWidget *seedWidget);
