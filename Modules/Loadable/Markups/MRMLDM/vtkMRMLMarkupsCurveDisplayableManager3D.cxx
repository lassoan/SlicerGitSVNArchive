...
//---------------------------------------------------------------------------
/// Create a new widget.
vtkAbstractWidget * vtkMRMLMarkupsCurveDisplayableManager3D::CreateWidget(vtkMRMLMarkupsNode* node)
{
  if (!node)
    {
...
void vtkMRMLMarkupsCurveDisplayableManager3D::OnWidgetCreated(vtkAbstractWidget * widget, vtkMRMLMarkupsNode * node)
{
  if (!widget)
    {
...
//---------------------------------------------------------------------------
bool vtkMRMLMarkupsCurveDisplayableManager3D::UpdateNthSeedPositionFromMRML(int n, vtkAbstractWidget *widget, vtkMRMLMarkupsNode *pointsNode)
{
  ...
  vtkMarkupsSplineRepresentation * splineRepresentation = vtkMarkupsSplineRepresentation::SafeDownCast(seedWidget->GetRepresentation());
  ...
  splineRepresentation->GetHandlePosition(n, seedWorldCoord);
...
//---------------------------------------------------------------------------
void vtkMRMLMarkupsCurveDisplayableManager3D::SetNthSeed(int n, vtkMRMLMarkupsCurveNode* curveNode, vtkMarkupsCurveWidget *seedWidget)
{
  ...
  int seedLocked = curveNode->GetNthMarkupLocked(n);
...
void vtkMRMLMarkupsCurveDisplayableManager3D::PropagateMRMLToWidget(vtkMRMLMarkupsNode* node, vtkAbstractWidget * widget)
{
  if (!widget)
    {
...
void vtkMRMLMarkupsCurveDisplayableManager3D::PropagateWidgetToMRML(vtkAbstractWidget * widget, vtkMRMLMarkupsNode* node)
{
  if (!widget)
    {
...
void vtkMRMLMarkupsCurveDisplayableManager3D::OnClickInRenderWindow(double x, double y, const char *associatedNodeID)
{
...
void vtkMRMLMarkupsCurveDisplayableManager3D::AdditionnalInitializeStep()
{
...
//---------------------------------------------------------------------------
void vtkMRMLMarkupsCurveDisplayableManager3D::UpdatePosition(vtkAbstractWidget *widget, vtkMRMLNode *node)
{
...
//---------------------------------------------------------------------------
void vtkMRMLMarkupsCurveDisplayableManager3D::OnMRMLMarkupsNodeNthMarkupModifiedEvent(vtkMRMLMarkupsNode* node, int n)
{
...
//---------------------------------------------------------------------------
void vtkMRMLMarkupsCurveDisplayableManager3D::OnMRMLMarkupsNodeMarkupAddedEvent(vtkMRMLMarkupsNode * markupsNode, int n)
{
...
//---------------------------------------------------------------------------
void vtkMRMLMarkupsCurveDisplayableManager3D::OnMRMLMarkupsNodeMarkupRemovedEvent(vtkMRMLMarkupsNode * markupsNode, int vtkNotUsed(n))
{
