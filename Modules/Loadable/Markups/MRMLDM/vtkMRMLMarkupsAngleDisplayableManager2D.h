...
#ifndef __vtkMRMLMarkupsAngleDisplayableManager2D_h
#define __vtkMRMLMarkupsAngleDisplayableManager2D_h
...
class VTK_SLICER_MARKUPS_MODULE_MRMLDISPLAYABLEMANAGER_EXPORT vtkMRMLMarkupsAngleDisplayableManager2D :
    public vtkMRMLMarkupsDisplayableManager2D
{
public:

  static vtkMRMLMarkupsAngleDisplayableManager2D *New();
  vtkTypeMacro(vtkMRMLMarkupsAngleDisplayableManager2D, vtkMRMLMarkupsDisplayableManager2D);
...
protected:
  ...
  void SetNthSeed(int n, vtkMRMLMarkupsAngleNode* fiducialNode, vtkSeedWidget *seedWidget);
...
private:
  ...
  vtkMRMLMarkupsAngleDisplayableManager2D(const vtkMRMLMarkupsAngleDisplayableManager2D&); /// Not implemented
  void operator=(const vtkMRMLMarkupsAngleDisplayableManager2D&); /// Not Implemented
