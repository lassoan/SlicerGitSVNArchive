...
public:
  ...
  vtkMeasurement* GetNthMeasurement(int id);
  void AddMeasurement(vtkMeasurement* measurement);
  void SetNthMeasurement(int id, vtkMeasurement* measurement);
...
protected:
  ...
  std::vector<vtkSmartPointer<vtkMeasurement>> Measurements;
};
