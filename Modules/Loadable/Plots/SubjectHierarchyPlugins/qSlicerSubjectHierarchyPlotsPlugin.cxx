...
: q_ptr(&object)
{
  this->PlotChartIcon = QIcon(":Icons/Chart.png");
  this->PlotSeriesIcon = QIcon(":Icons/Series.png");
...
void qSlicerSubjectHierarchyPlotsPlugin::setDisplayVisibility(vtkIdType itemID, int visible)
{
  ...
  vtkMRMLPlotChartNode* plotSeriesNode = vtkMRMLPlotChartNode::SafeDownCast(shNode->GetItemDataNode(itemID));
