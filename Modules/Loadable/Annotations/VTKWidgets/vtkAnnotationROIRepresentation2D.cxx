...
double vtkAnnotationROIRepresentation2D::ComputeHandleRadiusInWorldCoordinates(double handleSize)
{
  ...
  double windowDiameterInPixels = sqrt(screenSize[0] * screenSize[0] + screenSize[1] * screenSize[1]);
  double radiusInPixels = windowDiameterInPixels * handleSize;
  if (radiusInPixels < 1)
    {
    radiusInPixels = 1;
    }
