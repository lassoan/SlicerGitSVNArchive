/*=========================================================================
  ...
  Module:    vtkDelimitedTextReader2.h
...
// .NAME vtkDelimitedTextReader2 - reads in delimited ascii or unicode text files
// and outputs a vtkTable data structure.
//
// .SECTION Description
// vtkDelimitedTextReader2 is an interface for pulling in data from a
...
#ifndef vtkDelimitedTextReader2_h
#define vtkDelimitedTextReader2_h
...
class VTKIOINFOVIS_EXPORT vtkDelimitedTextReader2 : public vtkTableAlgorithm
{
public:
  static vtkDelimitedTextReader2* New();
  vtkTypeMacro(vtkDelimitedTextReader2, vtkTableAlgorithm);
...
private:
  vtkDelimitedTextReader2(const vtkDelimitedTextReader2&) VTK_DELETE_FUNCTION;
  void operator=(const vtkDelimitedTextReader2&) VTK_DELETE_FUNCTION;
