 ...
 *
 * The vtkSliceIntersectionWidget is used to perform affine transformations on objects.
 * (SliceIntersection transformations are transformations that keep parallel lines parallel.
 * SliceIntersection transformations include translation, scaling, rotation, and shearing.)
 *
